...
public class VirtualJoystickView extends RelativeLayout implements AnimationListener,
  ...
  private void onContactUp() {
    ...
    // by KKUEI
    Log.d("[KKUEI]", "ContactUpLocation.x = " + contactUpLocation.x);
    Log.d("[KKUEI]", "ContactUpLocation.y = " + contactUpLocation.y);
  ...
  private void publishVelocity(double linearVelocityX, double linearVelocityY,
    ...
    currentVelocityCommand.getLinear().setX(linearVelocityX * 0.3);  // [KKUEI] maxLinearVel = 0.3m/s
    ...
    currentVelocityCommand.getAngular().setZ(-angularVelocityZ * 1.0 );
  }
  ...
  public void onStart(ConnectedNode connectedNode) {
    ...
    Subscriber<nav_msgs.Odometry> subscriber =
        connectedNode.newSubscriber("/andbot/odom_diffdrive", nav_msgs.Odometry._TYPE);
